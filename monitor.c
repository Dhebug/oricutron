...
char* mon_disassemble(struct machine *oric, unsigned short* paddr, SDL_bool *looped, SDL_bool filemode)
{
  ...
  {
    case(MBPF_READ):
      disptr[SNAME_LEN+1] = 'r';
      break;
    case(MBPF_WRITE):
      disptr[SNAME_LEN+1] = 'w';
      break;
    case(MBPF_WRITE|MBPF_READ):
      disptr[SNAME_LEN+1] = 'a';
      break;
    case(MBPF_CHANGE):
      disptr[SNAME_LEN+1] = 'c';
      break;
    case(MBPF_CHANGE           |MBPF_READ):
      disptr[SNAME_LEN+1] = 'g';
      break;
    case(MBPF_CHANGE|MBPF_WRITE):
      disptr[SNAME_LEN+1] = 'm';
      break;
    case(MBPF_CHANGE|MBPF_WRITE|MBPF_READ):
      disptr[SNAME_LEN+1] = '+';
      break;
    case(8):
      disptr[SNAME_LEN+1] = 'X';
      break;
    case(8|                       MBPF_READ):
      disptr[SNAME_LEN+1] = 'R';
      break;
    case(8|            MBPF_WRITE):
      disptr[SNAME_LEN+1] = 'W';
      break;
    case(8|            MBPF_WRITE|MBPF_READ):
      disptr[SNAME_LEN+1] = 'A';
      break;
    case(8|MBPF_CHANGE):
      disptr[SNAME_LEN+1] = 'C';
      break;
    case(8|MBPF_CHANGE           |MBPF_READ):
      disptr[SNAME_LEN+1] = 'G';
      break;
    case(8|MBPF_CHANGE|MBPF_WRITE):
      disptr[SNAME_LEN+1] = 'M';
      break;
    case(8|MBPF_CHANGE|MBPF_WRITE|MBPF_READ):
      disptr[SNAME_LEN+1] = '*';
      break;
  }
